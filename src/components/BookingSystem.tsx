...
import { User, Clock, MapPin, Calendar as CalendarIcon, CheckCircle2 } from 'lucide-react'
        ...
        <Card className="max-w-md mx-auto text-center">
          <CardContent className="p-8">
            ...
            <p className="text-gray-600 mb-6">
              Your session has been scheduled. You'll receive a confirmation email shortly.
            </p>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                ...
                {selectedDate && (
                  <p className="text-sm text-gray-600 mt-4">
                    Showing availability for {selectedDate.toLocaleDateString()}
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            {/* Booking Summary */}
            {selectedCounselor && selectedDate && selectedTime && sessionType && (
        ...
        <Alert className="mt-8">
          ...
          <AlertDescription>
            <strong>Location:</strong> All sessions are held at the Campus Counseling Center (Building A, Room 201). 
            For your first visit, please arrive 10 minutes early to complete intake forms.
          </AlertDescription>
        </Alert>
      </div>
    </div>
